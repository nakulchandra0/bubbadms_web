		...
		<div class="content">
			...
			<section class="gray_bg">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h3 class="center"><?php echo $memberdata->first_name.' '.$memberdata->last_name; ?>'s Calculator With TDS inc</h3>
						</div>
					</div>

					<div class="row">
						<div class="col-md-6">
							<!-- <form class="profile_form" id="math_update_form"> -->
								<div class="form-group">
				     				<select class="form-control form_field" required="" name="math_buyer_select" id="math_buyer_select">
								...
								<div class="form-group">
				     			...
				     			<div class="form-group">
				     				<input type="number" name="math_cashcredit" id="math_cashcredit" class="form-control form_field" required="" onfocus="this.value = this.value=='0'?'':this.value;" onblur="this.value = this.value==''?'0':this.value;" onkeyup="return autocalculater()" value="0">
				     				<label class="form_label">Down Payment</label>
				     			</div>
				     			<div class="form-group">
				     				<input type="number" name="math_tradecredit" id="math_tradecredit" class="form-control form_field" required="" onfocus="this.value = this.value=='0'?'':this.value;" onblur="this.value = this.value==''?'0':this.value;" onkeyup="return autocalculater()" value="0">
				     				<label class="form_label">Trade In Credit</label>
				     			</div>

				     			<!-- <div class="form-group">
				     				<input type="number" name="math_tradebalance" id="math_tradebalance" class="form-control form_field" required="" onkeyup="return autocalculater()">
				     				<label class="form_label">Trade Balance</label>
				     			</div> -->
				     			<div class="form-group">
				     				<input type="number" name="math_tavtprice" id="math_tavtprice" class="form-control form_field" required="" onfocus="this.value = this.value=='0'?'':this.value;" onblur="this.value = this.value==''?'0':this.value;" onkeyup="return autocalculater()" value="0">
				     				<label class="form_label">GA TAVT Price</label>
				     			</div>
				     			<div class="form-group">
				     				<input type="text" name="math_taxrate" id="math_taxrate" class="form-control form_field" value="<?php if(!empty($memberdata->tax)) echo $memberdata->tax; else echo "7"; ?>" required="" onfocus="this.value = this.value=='0'?'':this.value;" onblur="this.value = this.value==''?'0':this.value;" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,''); return autocalculater()">
				     				<label class="form_label">Tax Rate(ex 7)</label>
				     			</div>
				     			<div class="form-group">
				     				<input type="number" name="math_servicefee" id="math_servicefee" class="form-control form_field" value="<?php echo empty($memberdata->dealer_fee)?'0':$memberdata->dealer_fee; ?>" required="" onfocus="this.value = this.value=='0'?'':this.value;" onblur="this.value = this.value==''?'0':this.value;" onkeyup="return autocalculater()">
				     				<label class="form_label">Service Fee</label>
				     			</div>
				     			<div class="form-group">
				     				<input type="number" name="math_tagregistration" id="math_tagregistration" class="form-control form_field" value="<?php echo empty($memberdata->dmv)?'0':$memberdata->dmv; ?>" required="" onfocus="this.value = this.value=='0'?'':this.value;" onblur="this.value = this.value==''?'0':this.value;" onkeyup="return autocalculater()">
				     				<label class="form_label">Tag/Registration</label>
				     			</div>
				     			<div class="form-group">
									<input type="hidden" class="form_btn" id="math_btn_total" value="Total(First)">
								</div>
				     			<div class="form-group">
				     			...
				     			<div class="form-group">
									<input type="submit" class="form_btn" id="math_update_submit" value="Update Buyer">
								</div>
							<!-- </form> -->
						</div>
						<div class="col-md-6">
							...
							<form class="profile_form" id="payment_calc_form">
								...
								<div class="form-group">
				     				...
				     				<label class="form_label viewlabel">Amount to Finance</label>
				     			</div>
				     			<div class="form-group">
				     			...
				     			<div class="form-group">
				     				<input type="text" name="calc_interest_rate" id="calc_interest_rate" class="form-control form_field" required="" onkeypress="return isFloatNumber(this,event)">
