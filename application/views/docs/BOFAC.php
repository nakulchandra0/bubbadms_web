...
<body>
	...
	<div class="container">
		<div class="row">
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<h3 class="text-center botom_space spacer"><b>OFAC COMPLIANCE STATEMENT <b/>
				</h3>
			</div>
				<div class="col-md-12">
				</div>
		<dixsv class="row">
			<div class="col-md-12 botom_space font_big_p">
				<table class="date_tb">
					<tr>
						<td class="date_td">Date
						</td>
						<td>
						  <b><input id="[ID1]" type="date" value="<?php echo date('Y-m-d',strtotime($date)); ?>" name="[NAME1]" class="fid00" autocomplete="no" min="[MIN1]" max="[MAX1]"  size="[SIZE1]"></b>
                ...
                <p>&nbsp; </p>
                <p>&nbsp; </p>
				<table width="550" border="1" cellpadding="10" class="info_table_2">
					<!--<tr>
						<td class="info_table_td_1"><span class="dt">Date</span><input class="info_table_input border_bottom border_left" type="text" name="6"></td>
					</tr>-->
					<tr>
						<td width="251" class="info_table_td">Company </td>
						<td width="247" class="info_table_td">Customer </td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<b>			<?php echo $buyers_data->buyers_first_name; ?> <?php echo $buyers_data->buyers_last_name; ?><br>
										<?php echo $buyers_data->buyers_address; ?><br>
										<?php echo $buyers_data->buyers_city; ?>, <?php echo $buyers_data->buyers_state; ?> <?php echo $buyers_data->buyers_zip; ?></b>
						</td>
					</tr>
			    </table>
			    ...
			    <p class="Affidavit botom_space">
			    		This is to certify that on the above date, the SDN-BLOCKED PERSON'S LIST was checked and the customer listed above was not found.
			    </p>
			    <div class="division">
		...
		<div class="row">
			<div class="col-md-6">
				<p> <input type="text" name="2"> <br> Signature of Company Representative  </p>
				<p> <input type="text" name="2"> <br> Signature of Customer </p>
			</div>
			<div class="col-md-6">
				<p> <input type="date" value="<?php echo date('Y-m-d',strtotime($date)); ?>" name="2"> <br> Date </p>
			</div>
			<div class="col-md-6">
				<p> <input type="date" value="<?php echo date('Y-m-d',strtotime($date)); ?>" name="2"> <br> Date  </p>
				  </div>
