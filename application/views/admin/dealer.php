								...
								<div class="col-xl-12 col-lg-12 order-lg-3 order-xl-1">
									<div class="kt-portlet kt-portlet--height-fluid">
										...
										<div class="kt-portlet__body">
											<table class="table table-separate table-head-custom table-hover table-checkable" id="dealer_table">
												<thead>
													<tr>
														<th>ID</th>
														<th>Dealer</th>
												...
												<tbody>
													<?php $no=1; foreach ($memberdata as $key => $value) { ?>
													<tr id="row<?php echo $value['id'] ?>">
														...
														<td><?php echo date('d M Y',strtotime($value['membership_expire'])) ?></td>
														<td>
															<span class="label label-lg font-weight-bold label-light-warning label-inline"><?php $packageData = $this->crud_model->filter_one("memberlogin_groups","id",$value['group_id']);
															if($packageData)
																echo $packageData[0]['group_title'];
															else
																echo "NA"; 
															 ?></span>
														</td>
													...
													<?php } ?>
													<!-- <span class="label label-lg font-weight-bold label-light-warning label-inline">Free</span> -->
													<!-- <span class="label label-danger label-dot mr-2"></span><span class="font-weight-bold text-danger">Deactive</span> -->
												</tbody>
											</table>
										</div>
									</div>
